...
{
    public class PaymentsController(PaymentsService paymentService, StoreContext context, IConfiguration config, ILogger<PaymentsController> logger) : BaseApiController
    {
        [Authorize]
        [HttpPost]
        ...
        public async Task<IActionResult> StripeWebhook()
        {
            ...
            try
            {
                ...
                {
                    return BadRequest("Invliad event data");
                }
